...
{image: require('../../../../images/coupehomme.jpg'), title: 'COUPE HOMME', links: categoryLinks},
{image: require('../../../../images/coiffure.jpg'), title: 'COIFFURE',  links: categoryLinks},
{image: require('../../../../images/visage.jpg'), title: 'VISAGE', links: categoryLinks},
{image: require('../../../../images/epilation.jpg'), title: 'EPILATION', links: categoryLinks},
]
                    ...
                    this.props.links && this.props.links.map((link, index, links) => { //render our subcategory links
                        return (
                            ...
                            <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                                ...
                                <Icon name="arrow-dropright" style={{paddingTop:5,paddingLeft:120}}>{link.icon}</Icon>
                           </View> 
                           </TouchableOpacity>
                           </View>
                        )
...
// ];
// export default class AccordionServices extends Component {
//   render() {
//     return (
//       <Container style={{heigth:200,width:400}}>
//         <Content padder>
//           <Accordion
//             dataArray={dataArray}
//             icon="add"
